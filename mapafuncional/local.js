...
arregloRegiones["VII"]={
    nombre: "Maule",
            ...
            atractivoTur: [
                 "Jardín botanico de la Universidad de Talca",
...
arregloRegiones["XI"]={
    ...
    atractivoTur: [
         "Parque Natural Cumbre de Cipreses",
         "Valle Lunar",
         "Parque Nacional Queular"
    ],
...
function IndicaRegion(elemento){
    ...
    atractivos.innerText = arregloRegiones[elemento.attributes.title.value].atractivoTur;
    ...
    atract1.value=arregloRegiones[elemento.attributes.title.value].atractivoTur[0];
    atract2.value=arregloRegiones[elemento.attributes.title.value].atractivoTur[1];
    atract3.value=arregloRegiones[elemento.attributes.title.value].atractivoTur[2];
}
